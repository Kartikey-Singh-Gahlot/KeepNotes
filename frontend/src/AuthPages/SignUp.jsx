...
export default function SignUp(){
 ...
 return(
    <div className="h-screen bg-gradient-to-r from-[#0B2B26] to-[#235347] flex flex-col  items-center">
      ...
      <main className="h-full flex flex-col items-center justify-center">
            <div className="box-border p-[8px]  rounded-2xl flex flex-col  items-center shadow-2xl text-white border-[#f5f5f542] border-[1px] bg-[url('/credentialsBG.jpg')] bg-cover bg-center ">     
